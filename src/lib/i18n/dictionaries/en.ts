...
export const en: Dictionary = {
  ...
  hero: {
    ...
    subheadlineSecondary:
      "Control planes · NestJS · Next.js · MCP · LLM · event-driven · production enterprise systems.",
  ...
  devBanner: {
    label: "WIP",
    message: "Portfolio under active development — content and layout may change.",
  },
};
